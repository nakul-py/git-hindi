...
const [firstColor, seconColor ,thirdColor, ...extraColors] = colors;

console.log(firstColor,seconColor,thirdColor,extraColors);*/
...
/*const person = {
    fullName: "Spongebob Squuarepants",
    age: 30,
    isStudent: true,
...
const person1 = new Person("spongebob", 22, 
                           "124 conch st.",
                           "Bikini bottom",
                           "Int. Waters");

const person2 = new Person("patrik", 13, 
                           "124 conch st.",
                           "Bikini bottom",
                           "Int. Waters");

const person3 = new Person("mr. crab", 43, 
                           "124 conch st.",
                           "Bikini bottom",
                           "Int. Waters");
